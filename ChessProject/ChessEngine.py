            ...
            if not piece_pinned or pin_direction == (move_amount, -1):
                ...
                if (row + move_amount, col - 1) == self.enpassantPossible:
                    ...
                    if not attacking_piece or blocking_piece:
                        moves.append(Move((row, col), (row + move_amount, col - 1), self.board, isEnpassanMove=True))
...
class Move:
    ...
    def __init__(self, start_square, end_square, board, isEnpassanMove=False, isCastleMove=False):
